...
Eina_Bool SettingsMain::getOriginalState(int id)
{
    ...
    switch (id) {
        case ZOOM:
            sig = SettingsPrettySignalConnector::Instance().getWebEngineSettingsParam(basic_webengine::WebEngineSettings::PAGE_OVERVIEW);
            break;
        default:
            sig = false;
            break;
...
void SettingsMain::grid_item_check_changed(void* data, Evas_Object* obj, void*)
{
    ...
    switch (itd->id) {
        case ZOOM:
            ...
            SettingsPrettySignalConnector::Instance().setWebEngineSettingsParam(basic_webengine::WebEngineSettings::PAGE_OVERVIEW, static_cast<bool>(value));
            break;
        default:
            break;
    }
