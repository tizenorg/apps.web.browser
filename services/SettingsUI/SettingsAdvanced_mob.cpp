...
Eina_Bool SettingsAdvanced::getOriginalState(int id)
{
    ...
    switch (id){
        case ENABLE_JS:
            ...
            break;
        case BLOCK_POPUPS:
            sig = getWebEngineSettingsParam(basic_webengine::WebEngineSettings::SCRIPTS_CAN_OPEN_PAGES);
            break;
        default:
            sig = false;
            break;
...
void SettingsAdvanced::grid_item_check_changed(void* data, Evas_Object* obj, void*)
{
    ...
    switch (itd->id){
        case ENABLE_JS:
            ...
            itd->sui->setWebEngineSettingsParam(basic_webengine::WebEngineSettings::ENABLE_JAVASCRIPT, static_cast<bool>(value));
            break;
        case BLOCK_POPUPS:
            elm_check_state_set(obj, value);
            itd->sui->setWebEngineSettingsParam(basic_webengine::WebEngineSettings::SCRIPTS_CAN_OPEN_PAGES, static_cast<bool>(value));
            break;
        default:
            break;
    }
