...
char *AutoFillFormComposeView::__text_get_cb(void *data, Evas_Object *obj, const char *part)
{
    ...
    genlistCallbackData *cb_data = (genlistCallbackData *)data;
...
Evas_Object *AutoFillFormComposeView::__content_get_cb(void *data, Evas_Object *obj, const char *part)
{
    ...
    genlistCallbackData *cb_data = (genlistCallbackData *)data;
    AutoFillFormComposeView *view = (AutoFillFormComposeView *)cb_data->user_data;
    AutoFillFormComposeView::menu_type type = cb_data->type;
...
void AutoFillFormComposeView::__done_button_cb(void *data, Evas_Object *obj, void *event_info)
{
    ...
    AutoFillFormComposeView *view = (AutoFillFormComposeView *)data;
...
void AutoFillFormComposeView::__entry_clicked_cb(void *data, Evas_Object *obj, void *eventInfo)
{
    BROWSER_LOGD("-----------[%s : %d]---------", __PRETTY_FUNCTION__, __LINE__);
    RET_MSG_IF(!data, "data is NULL");
...
void AutoFillFormComposeView::__entry_next_key_cb(void *data, Evas_Object *obj, void *eventInfo)
{
    BROWSER_LOGD("-----------[%s : %d]---------", __PRETTY_FUNCTION__, __LINE__);
    RET_MSG_IF(!data, "data is NULL");

    genlistCallbackData *callback_data = (genlistCallbackData *)data;
    AutoFillFormComposeView *view_this = (AutoFillFormComposeView *)callback_data->user_data;
