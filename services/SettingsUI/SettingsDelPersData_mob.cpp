...
void SettingsDelPersData::__cancel_button_cb(void* data, Evas_Object*, void*)
{
    BROWSER_LOGD("[%s:%d] ", __PRETTY_FUNCTION__, __LINE__);
    SettingsDelPersData* safc = static_cast<SettingsDelPersData*>(data);
...
void SettingsDelPersData::__delete_button_cb(void* data, Evas_Object*, void*)
{
    BROWSER_LOGD("[%s:%d] ", __PRETTY_FUNCTION__, __LINE__);
    SettingsDelPersData* safc = static_cast<SettingsDelPersData*>(data);
    safc->deleteSelectedDataClicked(safc->m_option);
    safc->closeSettingsUIClicked();
}
