...
public:
    ...
    SetPtr prepareOnOpenSettings(const SettingsMainOptions& s);
    SetPtr prepareOnCloseSettings();
    ...
    std::vector<std::shared_ptr<SettingsUI> > getSettingsVector() { return m_settingsVector; }

private:
    std::map<SettingsMainOptions,SetPtr> m_settingsViews;
    Evas_Object* m_parent;
    std::vector<std::shared_ptr<SettingsUI>> m_settingsVector;
};
}
}
