...
/*
 * CertificateStorage.h
 *
 *  Created on: Jan 06, 2015
 *      Author: gajendra.n@samsung.com
 */
...
public:
     ...
     */
    unsigned int addCertificateEntry(const std::string& pem, const std::string& host, int allow);

    /**
     * Update pem and allow values for host.
     */
    void updateCertificateEntry(const std::string& pem, const std::string& host, int allow);
