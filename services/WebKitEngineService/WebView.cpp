...
#ifdef HW_BACK_KEY
    eext_object_event_callback_add(m_ewkView, EEXT_CALLBACK_BACK, backCallbackCalled, this);
#endif
#endif
}
...
#ifdef HW_BACK_KEY
    eext_object_event_callback_del(m_ewkView, EEXT_CALLBACK_BACK, backCallbackCalled);
#endif
#endif
}

#ifdef HW_BACK_KEY
void WebView::backCallbackCalled(void* data, Evas_Object*, void*) {
