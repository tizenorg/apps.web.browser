...
public:
    ...
    boost::signals2::signal<void (const std::string&, const std::string&, int)> addCertificateEntry;
    boost::signals2::signal<void (const std::string&, const std::string&, int)> updateCertificateEntry;
