...
#if PROFILE_MOBILE
    edje_object_signal_callback_add(elm_layout_edje_get(m_mainLayout), "mouse,clicked,1", "moremenu_dimmed_bg", _bookmark_manager_background_clicked, this);
#endif
...
#if PROFILE_MOBILE
void WebPageUI::_bookmark_manager_background_clicked(void* data, Evas_Object*, const char*, const char*)
{
    BROWSER_LOGD("[%s:%d] ", __PRETTY_FUNCTION__, __LINE__);
    WebPageUI*  webPageUI = static_cast<WebPageUI*>(data);
