...
private:
    ...
    void showCertificatePopup(const std::string& host, const std::string& pem, CertificateContents::HOST_TYPE type);
    ...
    void setCertificatePem(std::string uri, std::string pem, bool valid);
    void loadHostCertInfoFromDB();
    void saveCertificateInfo(const std::string&, const std::string&, bool validCert, bool allowUnsecureCert=false);
