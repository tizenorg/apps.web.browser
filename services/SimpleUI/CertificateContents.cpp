...
Evas_Object* CertificateContents::getContent()
{
    ...
    if (!isValidCertificate()) {
        return createLabel(m_parent, BR_STRING_UNABLE_TO_VIEW_THE_CERTIFICATE_THE_PAGE_INFORMATION_HAS_BEEN_CHANGED);
    } else if (m_certData._cert_type != VALID) {
...
// TODO: coś jeszcze z tytułem trzeba wymślić, żeby ustawiać go w popupie
...
//     elm_layout_content_set(m_mainLayout, "content_swallow", status_content);
