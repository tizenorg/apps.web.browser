...
CertificateContents::HOST_TYPE CertificateContents::isCertExistForHost(const char *host)
{
...
void CertificateContents::addToHostCertList(const char *host, HOST_TYPE type)
{
    BROWSER_LOGD("[%s:%d] ", __PRETTY_FUNCTION__, __LINE__);
