...
void CertificateContents::showViewCertificatePopup(bool isConfirmationPopup)
{
    BROWSER_LOGD("[%s:%d] ", __PRETTY_FUNCTION__, __LINE__);
...
//         m_popup->setButtonCount(2);
//         m_popup->setLeftButton(BACK_TO_SAFETY);
//         m_popup->setRightButton(CONTINUE);
    }
    else {
//         m_popup->setButtonCount(1);
//         m_popup->setMiddleButton(OK);
