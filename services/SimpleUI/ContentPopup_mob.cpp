...
Evas_Object* ContentPopup::createButtonBarLayout(Evas_Object* parent, unsigned buttonCount)
{
    ...
    switch(buttonCount) {
        case 1:
        {
           elm_layout_file_set(layout, edjFilePath.c_str(), "1_button_bar");
        ...
        case 2:
        {
           elm_layout_file_set(layout, edjFilePath.c_str(), "2_button_bar");
           elm_layout_text_set(layout,
                   "right_button_text",
        ...
        case 3:
        {
           elm_layout_file_set(layout, edjFilePath.c_str(), "3_button_bar");
           elm_layout_text_set(layout,
                   "left_button_text",
                   buttonsTranslations[m_left_button_type].c_str());
           elm_layout_text_set(layout,
