...
void SimpleUI::connectModelSignals()
{
    ...
    m_certificateContents->addCertificateEntry.connect(boost::bind(&storage::CertificateStorage::addCertificateEntry, &m_storageService->getCertificateStorage(), _1, _2, _3));
    m_certificateContents->updateCertificateEntry.connect(boost::bind(&storage::CertificateStorage::updateCertificateEntry, &m_storageService->getCertificateStorage(), _1, _2, _3));
    ...
    switch(webConfirmation->getConfirmationType())
    {
        ...
        case basic_webengine::WebConfirmation::ConfirmationType::CertificateConfirmation:
        {
            if (m_webPageUI->stateEquals(WPUState::MAIN_WEB_PAGE)) {
                ...
                services::CertificateContents::HOST_TYPE type = m_certificateContents->isCertExistForHost(cert->getURI());
