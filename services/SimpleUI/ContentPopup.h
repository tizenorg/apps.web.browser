...
public:
    ...
    void setMiddleButton(const PopupButtons& button);
    void setRightButton(const PopupButtons& button);
    void setButtonCount(unsigned count);
    void createLayout();
    void enlarge();
...
private:
    ...
    Evas_Object* createButtonBarLayout(Evas_Object* parent, unsigned buttonCount);

    Evas_Object* m_parent;
    Evas_Object* m_layout;
    Evas_Object* m_button_bar_layout;
    Evas_Object* m_left_button;
    Evas_Object* m_middle_button;
    Evas_Object* m_right_button;
    PopupButtons m_left_button_type;
    PopupButtons m_middle_button_type;
    PopupButtons m_right_button_type;
    std::string m_title;
    Evas_Object* m_content;
    unsigned m_button_count;
    static void _left_response_cb(void* data, Evas_Object* obj, void* event_info);
    static void _middle_response_cb(void* data, Evas_Object* obj, void* event_info);
