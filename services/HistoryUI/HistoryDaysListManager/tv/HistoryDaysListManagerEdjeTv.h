...
typedef struct HistoryDaysListManagerEdjeTv_ {

    HistoryDaysListManagerEdjeTv_()
...
} HistoryDaysListManagerEdjeTv;

typedef std::shared_ptr<const HistoryDaysListManagerEdjeTv> HistoryDaysListManagerEdjeTvPtr;
