...
void WebsiteHistoryItemVisitItemsTv::setFocusChain(Evas_Object* obj)
{
    for(auto& websiteVisitItem : m_websiteVisitItems) {
        elm_object_focus_allow_set(websiteVisitItem.
                layoutVisitItemObjects.buttonSelect, EINA_TRUE);
        elm_object_focus_custom_chain_append(obj, websiteVisitItem.
                layoutVisitItemObjects.buttonSelect, NULL);
    }
}
        ...
        WebsiteVisitItemDataPtr websiteVisitItemData)
{
    ...
    elm_object_part_content_set(lay, "imageClear",
            imageClear);
...
void WebsiteHistoryItemVisitItemsTv::deleteCallbacks()
{
    for(auto& visitItem : m_websiteVisitItems) {
        evas_object_smart_callback_del(visitItem.layoutVisitItemObjects.buttonSelect, "clicked", NULL);
    }
}
...
void WebsiteHistoryItemVisitItemsTv::initCallbacks()
{
    for(auto& websiteVisitItem : m_websiteVisitItems) {
        evas_object_smart_callback_add(
                ...
                "clicked",_buttonSelectClicked,
                &websiteVisitItem);

        evas_object_smart_callback_add(
                websiteVisitItem.layoutVisitItemObjects.buttonSelect,
                "focused",_buttonSelectFocused,
                &websiteVisitItem);

        evas_object_smart_callback_add(
                websiteVisitItem.layoutVisitItemObjects.buttonSelect,
                "unfocused",_buttonSelectUnfocused,
                websiteVisitItem.layoutVisitItemObjects.imageClear);
    }
}
        ...
        Evas_Object* /*obj*/, void* /*event_info*/)
{
    ...
    if(visitItemObject->deleteManager->getDeleteMode()) {
        Evas_Object* imageClear = visitItemObject->layoutVisitItemObjects.imageClear;
