...
public:
     ...
     */
    std::shared_ptr<tizen_browser::tools::BrowserImage> getSnapshotData(int width, int height, tizen_browser::config::SnapshotType snapshot_type);

    std::shared_ptr<tizen_browser::tools::BrowserImage> getSnapshotData(TabId id, int width, int height, bool async, tizen_browser::config::SnapshotType snapshot_type);
...
private:
    ...
    void _snapshotCaptured(std::shared_ptr<tizen_browser::tools::BrowserImage> snapshot, config::SnapshotType snapshot_type);
