...
//#define default_sd_card_storage_path "/home/owner/content/Downloads/"
...
private:
	...
	Eina_Bool _set_downloaded_file_on_notification(const char *downloaded_path, const char *file_name, const char *uri);
