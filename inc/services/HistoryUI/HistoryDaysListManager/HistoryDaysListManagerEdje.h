...
typedef struct HistoryDaysListManagerEdje_ {
    ...
    : historyDaysList(std::string("edje/HistoryUI/HistoryDaysList.edj"))
    , websiteHistoryItem(std::string("edje/HistoryUI/WebsiteHistoryItem.edj"))
    , websiteHistoryItemTitle(std::string("edje/HistoryUI/WebsiteHistoryItemTitle.edj"))
    , websiteHistoryItemVisitItems(std::string("edje/HistoryUI/WebsiteHistoryItemVisitItems.edj"))
    {}
