...
#include "services/WebPageUI/UrlHistoryList/GenlistManager.h"
#include "services/WebPageUI/UrlHistoryList/GenlistManagerCallbacks.h"
#include "services/WebPageUI/UrlHistoryList/UrlMatchesStyler.h"
#include "services/WebPageUI/UrlHistoryList/GenlistItemsManager.h"
        ...
        const char* part)
{
    ...
    if (strcmp(part, "matched_url") == 0) {
        ...
        if (item) {
            string edjFilePath = "edje/WebPageUI/UrlHistoryList.edj";
