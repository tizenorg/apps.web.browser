...
#include <chromium-ewk/ewk_chromium.h>
...
#include "services/SimpleUI/SimpleUI.h"
#include "services/WebPageUI/WebPageUIStatesManager.h"
...
#include "services/QuickAccess/DetailPopup.h"
#include "services/WebPageUI/UrlHistoryList/UrlHistoryList.h"
#include "services/SimpleUI/NotificationPopup.h"
...
void SimpleUI::handleConfirmationRequest(basic_webengine::WebConfirmationPtr webConfirmation)
{
    ...
    switch(webConfirmation->getConfirmationType())
    {
        ...
        std::string edjFilePath = "edje/SimpleUI/AuthenticationPopup.edj";
...
void SimpleUI::settingsDeleteSelectedData(const std::string& str)
{
    ...
    M_ASSERT(m_viewManager.getContent());
