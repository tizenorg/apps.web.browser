...
#define BR_STRING_USER_HOMEPAGE	_("User homepage")
#define BR_STRING_EMPTY_PAGE	_("Empty page")
...
#define BR_STRING_MULTI_WINDOW 	_("IDS_BR_HEADER_MULTI_WINDOW")
...
#define BR_STRING_HISTORIES 	"Histories"
...
#define BR_STRING_CLICK_HERE 	"Please click here"
...
#define BR_STRING_SELECTED	_("IDS_BR_OPT_SELECTED")
#define BR_STRING_SELECT_ALL	_("IDS_BR_OPT_SELECT_ALL")
#define BR_STRING_SELECT_ITEMS	_("IDS_BR_HEADER_SELECT_ITEMS")
#define BR_STRING_SELECT_HISTORIES	"Select histories"
#define BR_STRING_WARNING_OVER_BOOKMARK_LIMIT "It's reached maximum number of bookmark items, please delete it before adding"
#define BR_STRING_ALREADY_EXISTS _("IDS_BR_POP_ALREADY_EXISTS")
#define BR_STRING_FOLDERS	_("IDS_BR_OPT_FOLDERS")
#define BR_STRING_EMPTY_FOLDER_NAME	_("IDS_BR_POP_ENTER_FOLDER_NAME")
#define BR_STRING_EMPTY_FOLDER	"Empty folder"
...
#define BR_STRING_MOST_VISITED_GUIDE_TEXT	"Offer 3 thumbnails of most visited sites to let you access to each site easily"
...
#define BR_STRING_SHARE_VIA_FACEBOOK	_("IDS_BR_OPT_SHARE_VIA_FACEBOOK")
#define BR_STRING_SHARE_VIA_TWITTER	_("IDS_BR_OPT_SHARE_VIA_TWITTER")
#define BR_STRING_SHARE_VIA_NFC	_("Share via NFC")
...
#define BR_STRING_NFC   "NFC" //dgettext("sys_string", "IDS_COM_BODY_NFC")
...
#define BR_STRING_FIND_WORD	_("IDS_BR_BODY_FIND_WORD")
...
#define BR_STRING_ADD_TO_MOST_VISITED_SITES	"Add to Most visited sites"
#define BR_STRING_MY_SITES_GUIDE_TEXT	"You can add, delete, pin or unpin each item of \"My sites\" by doing a long press. <br>You can also reorder items of \"My sites\" by drag and drop."
#define BR_STRING_MY_SITES_NEVER_SHOW_TEXT	"Never show this again."
#define BR_STRING_WARNING_VIDEO_PLAYER "Can not launch video-player while video-call is running."
...
#define BR_STRING_NO_SEARCH_RESULT	"No search result"
#define BR_STRING_NO_URL_TO_POST    _("There is no URL to post")
#define BR_STRING_REQUEST_LOCATION	" is requesting your current location."
#define BR_STRING_ALLOW	_("IDS_BR_OPT_ALLOW")
#define BR_STRING_REFUSE	_("IDS_BR_POP_REFUSE")
#define BR_STRING_ADD_RSS_FEED _("IDS_BR_OPT_ADD_RSS_FEED")
#define BR_STRING_FORWARD _("IDS_BR_OPT_NAVIGATE_GO_FORWARD")
...
#define BR_STRING_DISPLAY	_("IDS_BR_OPT_DISPLAY")
...
#define BR_STRING_CONTENT	_("IDS_BR_MBODY_PAGE_CONTENT_SETTINGS")
#define BR_STRING_RUN_JAVASCRIPT	_("IDS_BR_BODY_RUN_JAVASCRIPT")
#define BR_STRING_DISPLAY_IMAGES	_("IDS_BR_BODY_DISPLAY_IMAGES")
#define BR_STRING_BLOCK_POPUP	_("IDS_BR_MBODY_BLOCK_POP_UP_WINDOWS")
#define BR_STRING_PRIVACY	_("IDS_BR_BODY_PRIVACY")
#define BR_STRING_ACCEPT_COOKIES	_("IDS_BR_BODY_COOKIES")
#define BR_STRING_AUTO_SAVE_ID_PASSWORD	_("IDS_BR_BODY_AUTO_SAVE_ID_PASSWORD")
...
#define BR_STRING_CLEAR_PRIVATE_DATA	_("IDS_BR_BODY_DELETE_BROWSING_DATA")
#define BR_STRING_CACHE	_("IDS_BR_BODY_CLEAR_CACHE")
#define BR_STRING_COOKIE	_("IDS_BR_BODY_CLEAR_ALL_COOKIE_DATA")
...
#define BR_STRING_DEBUG	_("IDS_BR_BODY_DEVELOPER_MODE")
#define BR_STRING_USER_AGENT	_("IDS_BR_HEADER_USER_AGENT")

#define BR_STRING_STORAGE	_("IDS_BR_HEADER_LOCAL_STORAGE")
#define BR_STRING_DEFAULT_STORAGE	_("IDS_BR_BODY_DEFAULT_STORAGE")
#define BR_STRING_PHONE	_("IDS_BR_BODY_PHONE")
#define BR_STRING_MEMORY_CARD	_("IDS_BR_BODY_MEMORY_CARD")
#define BR_STRING_READER	_("IDS_BR_BODY_TEXT_READER")
#define BR_STRING_RUN_READER	"Run Reader"
#define BR_STRING_FONT_SIZE	_("IDS_BR_BODY_FONT_SIZE")
#define BR_STRING_ABOUT_BROWSER	_("IDS_BR_BODY_ABOUT_BROWSER")
#define BR_STRING_PLUGINS	_("IDS_BR_BODY_PLUG_IN")
#define BR_STRING_ENABLE_PLUGINS	_("IDS_BR_BODY_ENABLE_PLUG_INS")
#define BR_STRING_RUN_FLASH	_("IDS_BR_BODY_RUN_FLASH")
#define BR_STRING_PAUSE_FLASH_AT_PANNING	_("Pause flash at panning")
#define BR_STRING_RESET_TO_DEFAULT	"Reset to default"

/* waring message */
#define BR_STRING_MSG_BOUNDARY_LACK_OF_SPACE_TO_SAVE_HTML       _("Not enough space to save a html file")
...
#define BR_STRING_PERMISSION_CHECK	"Permission check"
#define BR_STRING_WEB_NOTIFICATION_Q	_("Do you want to receive web notification?")

/* browser context menu */
#define BR_STRING_CTXMENU_OPEN_LINK_IN_NEW_WINDOW       _("IDS_BR_BODY_OPEN_IN_NEW_WINDOW")//"Open link in new window"
#define BR_STRING_CTXMENU_DOWNLOAD_LINKED_FILE          _("IDS_BR_BODY_DOWNLOAD")//"Download linked file"
#define BR_STRING_CTXMENU_COPY_LINK_LOCATION            _("IDS_BR_BODY_COPY_URL")//"Copy link location"
#define BR_STRING_CTXMENU_OPEN_IMAGE_IN_NEW_WINDOW      _("IDS_BR_BODY_VIEW_IMAGE")//"Open image in new window"
#define BR_STRING_CTXMENU_OPEN_MEDIA_IN_NEW_WINDOW      _("IDS_BR_BODY_PLAY")//"Open media in new window"
#define BR_STRING_CTXMENU_COPY_IMAGE_LOCATION           _("IDS_BR_BODY_COPY_URL")//"Copy image location"
...
#define BR_STRING_CTXMENU_SEND_IMAGE_VIA_EMAIL          _("IDS_BR_OPT_SEND_VIA_EMAIL")//"Send image via email"
#define BR_STRING_CTXMENU_SEND_IMAGE_VIA_MESSAGE        _("IDS_BR_OPT_SEND_VIA_MESSAGE")//"Send image via message"
#define BR_STRING_CTXMENU_OPEN_VIDEO_IN_NEW_WINDOW      _("Open video in new window")
#define BR_STRING_CTXMENU_OPEN_AUDIO_IN_NEW_WINDOW      _("Open audio in new window")
...
#define BR_STRING_CTXMENU_CUT                           _("Cut")
