...
##### History ######
if [ ! -f %{appdatadir}/data/db/.browser-history.db ];
then
	sqlite3 %{appdatadir}/data/db/.browser-history.db 'PRAGMA journal_mode=PERSIST;
...
##### Bookmarks #####
if [ ! -f %{appdatadir}/data/db/.browser-bookmark.db ];
then
	sqlite3 %{appdatadir}/data/db/.browser-bookmark.db 'PRAGMA journal_mode=PERSIST;
